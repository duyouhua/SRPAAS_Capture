package com.srpaas.capture.demo.camera;

import android.content.pm.ActivityInfo;
import android.os.Bundle;

/**
 * Created by cui on 2018/1/23.
 */
import android.os.Bundle;
...
import com.srpaas.capture.demo.R;
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                Log.e("","setupCamera....."+cameraId+" : "+manager.getCameraIdList().length+" : "+manager.getCameraIdList()[0]);
